    ...
    <main>
        <div class="filtro">
            ...
            <div>
                ...
                <input type="date" id="txtData" value="<?php print"$data";?>" onchange="mostrarTabela()"> 
            </div>
            <div>
        ...
        <div class="tabela">
            <table >
                ...
                <?php
                    ...
                    $sql = 'SELECT * FROM agendamentos WHERE dia = ?';
                    $parametros = [$data];
                    ...
                    if(empty($dados)){
                        print "
                            <script>
                                alert('Não há horários agendados para esse dia!')
